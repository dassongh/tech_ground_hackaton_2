...
export const InternalServer = generateErrorSchemaForSwagger(500, 'Internal Server Error');

export default function generateErrorSchemaForSwagger(statusCode: number, description: string) {
  return {
    [statusCode]: {
