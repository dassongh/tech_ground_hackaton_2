...
export default class Router {
	...
	public routes(): void {
		this.router.post('/', authenticate, validateBody(this.schema.create), this.controller.create);
		...
		this.router.delete('/:id', authenticate, validateParams(idInParams), this.controller.deleteById);
	}
}
